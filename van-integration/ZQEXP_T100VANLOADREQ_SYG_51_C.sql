 ...
 INNER JOIN T041PARTYDIV CUST
    ON (t.CODCUSTINV = CUST.CODPARTY AND t.CODDIV = CUST.CODDIV)
 WHERE t.CODSTATUS = '1'
   AND t.CODDIV = 'SYG'
   AND t.CODTYPORD = '51'
   and t.codusr != 'KDSM1'
